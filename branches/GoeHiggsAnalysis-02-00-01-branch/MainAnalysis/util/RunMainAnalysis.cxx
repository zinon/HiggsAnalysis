...
//  std::string localSampleDir = "/localscratch4/novaj/DC14_samples/";
//  std::string localSampleDir = "/localscratch1/scheiric/DATA/";
  std::string localSampleDir = "/localscratch4/scheiric/mc14_13TeV_Htautau_ll/";
//    std::string localSampleDir = "/localscratch4/scheiric/mc14_13TeV_Ztautau";
...
//  job.options()->setDouble (EL::Job::optMaxEvents, 10000); //job option - only 10 events processed
  ...
  if(runGrid){ //if Gridrun specified in main arguments
    ...
    driver.options()->setString("nc_outputSampleName", ("user."+user+".%in:name[2]%.rundebug07").c_str()); //name of output dataset
