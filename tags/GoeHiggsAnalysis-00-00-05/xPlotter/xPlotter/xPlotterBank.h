  ...
  vector< BankT > BankV // nested list-initialization
    {
      ...
      /*sample ID, process details, N events, Sum of weighted events, xsec, kFactor, generator or filter eff, multiplication factor*/
	...
	//	make_tuple("167749", "", , , /*pb*/, 1., , pb2fb),
	//make_tuple("167750", "", , , /*pb*/, 1., , pb2fb),
	//make_tuple("167751", "", , , /*pb*/, 1., , pb2fb),
