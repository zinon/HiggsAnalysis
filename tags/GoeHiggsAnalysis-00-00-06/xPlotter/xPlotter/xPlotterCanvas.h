...
class xPlotterCanvas {
 ...
 public:
  ...
  void Canvas(const CanvasCasesT &t,
	...
	cout<<"drawing "<<order<<" : NOMINAL : "<< get<2>(t)<<":"<< get<1>(t) <<" : "<< get<0>(t) <<endl;
    ...
    if(m_y_axis_2_ndivisions) hEmpty1->GetYaxis()->SetNdivisions( m_y_axis_2_ndivisions );
