...
class xTools {
 ...
 public: //variables
  ...
  bool MassCollinear(const xAOD::TauJetContainer *, const xAOD::MuonContainer *, 
		     const xAOD::MissingET*, const bool, double &, double &, double &);
  bool MassCollinear(const xAOD::TauJetContainer *, unsigned int, const xAOD::MuonContainer *, unsigned int, 
		     const xAOD::MissingET*, const bool, double &, double &, double &);
