...
//    driver.options()->setString("nc_nFiles", "1"); //Files to be processed from data set
    driver.options()->setString("nc_nFilesPerJob", "10"); //Files to be processed from data set
 
// driver.options()->setString(EL::Job::optGridNfilesPerJob, "10"); //By default, split in as few jobs as possible
 
 driver.options()->setString("nc_outputSampleName", ("user."+user+".%in:name[2]%.runGrid_noSys_140121_02").c_str()); //name of output dataset
